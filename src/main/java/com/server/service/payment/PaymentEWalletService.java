...
public class PaymentEWalletService implements IPaymentService {

    private final PaymentRepository paymentRepository;

    public PaymentEWalletService(PaymentRepository paymentRepository) {
    ...
    public boolean pay(Purchase purchase) {
        ...
        payment.setPaymentMethod(PaymentMethod.E_WALLET);
